        ...
        <div className="space-y-4">
          ...
          <div className="glass-card p-4 rounded-2xl space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-600 resize-none focus:outline-none focus:border-cyan-500/50 transition-colors"
